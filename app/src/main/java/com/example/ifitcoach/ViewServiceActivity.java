            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    if(dataSnapshot.hasChild("servicefirstimage"))
                    {
                        ...
                        {
                            Picasso.get().load(strServiceFirstImage).placeholder(R.drawable.default_image).into(ServiceFirstImage);
                        }
                    }
                    ...
                    if(dataSnapshot.hasChild("servicesecondimage"))
                    {
                        ...
                        if(!strServiceSecondImage.isEmpty())
                        {
                            ...
                            Picasso.get().load(strServiceSecondImage).placeholder(R.drawable.default_image).into(ServiceSecondImage);
                        }
                    }
                    ...
                    if(dataSnapshot.hasChild("servicethirdimage"))
                    {
                        ...
                        if(!strServiceThirdImage.isEmpty())
                        {
                            ...
                            Picasso.get().load(strServiceThirdImage).placeholder(R.drawable.default_image).into(ServiceThirdImage);
                        }
                    }
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                                {
                                    if(dataSnapshot.exists())
                                    {
                                        ...
                                        if(dataSnapshot.hasChild("userimage"))
                                        {
                                            ...
                                            {
                                                Picasso.get().load(strServiceOwnerImage).placeholder(R.drawable.profile_image_placeholder).into(ServiceOwnerImage);
                                            }
                                        }
